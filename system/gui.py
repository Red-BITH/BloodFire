...
def install_libraries():
    ...
    os.system("sudo pip3 install tabulate")
    os.system("sudo apt install nmap")
    os.system("sudo pip install requests")
    os.system("sudo pip install json")
    os.system("sudo pip install getmac")
    ...
    os.system("wget -O system/fdinfo.py https://raw.githubusercontent.com/Red-BITH/TCWBFnew/main/TCWBF-TOOL/federalsorgu.py")
